...
namespace Offsets {
    ...
    namespace AnimationTrack {
         ...
         inline constexpr uintptr_t IsPlaying = 0x510;
         inline constexpr uintptr_t Looped = 0xed;
    ...
    namespace FFlags {
         inline constexpr uintptr_t DebugDisableTimeoutDisconnect = 0x6542450;
         inline constexpr uintptr_t EnableLoadModule = 0x65317b0;
         inline constexpr uintptr_t PartyPlayerInactivityTimeoutInSeconds = 0x64f7d98;
         inline constexpr uintptr_t TaskSchedulerTargetFps = 0x6e54cc8;
         inline constexpr uintptr_t WebSocketServiceEnableClientCreation = 0x654f058;
    }
    ...
    namespace Sky {
         ...
         inline constexpr uintptr_t SunAngularSize = 0x1a4;
    ...
    namespace StatsItem {
         inline constexpr uintptr_t Value = 0x2c0;
    }
